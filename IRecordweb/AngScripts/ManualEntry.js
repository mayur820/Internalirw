...
app.controller("myctrn", function ($scope, $http) {
    ...
    $scope.changeSegment = function () {
        ...
        if ($scope.ddlSegment == "0") {
            ...
            $("#div_OrderNo").removeClass("displayNO");
            //
    ...
    $scope.GetISIN = function ()
    {
      debugger;
      //alert($("#ddlScript_Id").val());
       fnGetDataUsingGetRequestWithModel("/BrokerBillEntry/FnGetScript?ScriptID=" + $("#ddlScript_Id").val(), "ISINInfo", $scope, $http);
      var db= JSON.stringify($scope.ISIN);
    ...
    {
      debugger;
     // alert($scope.ddlBroker);
       fnGetDataUsingGetRequestWithModel("/BrokerBillEntry/FnGetClientCode?BrokerID=" + $scope.ddlBroker, "ClientCodeInfo", $scope, $http);
   }
     $scope.bindISIN = function () {
       $scope.GetISIN();
    }
    ...
    $scope.FnAdd = function () {
        ...
        $scope.singlemodel.txt_ClientCode  = $scope.txt_ClientCode;
        $scope.singlemodel.txt_SettlementDate = $scope.txt_SettlementDate;
        $scope.singlemodel.ddlExchangeType = $scope.ddlExchangeType;
        $scope.singlemodel.txt_ISIN  = $scope.txt_ISIN;
        $scope.singlemodel.txt_OrderNo = $scope.txt_OrderNo;
        $scope.singlemodel.txt_OrderTime= $scope.txt_OrderTime;
        $scope.singlemodel.txt_TradeNo = $scope.txt_TradeNo;
        $scope.singlemodel.txt_TradeTime = $scope.txt_TradeTime;
        $scope.singlemodel.txt_TradeDate= $scope.txt_TradeDate;
        ...
        try {
            ...
            $scope.singlemodel.txt_SettlementDate = $("#txt_SettlementDate").val();
            $scope.singlemodel.txt_BillNo = $("#txt_BillNo").val();
            $scope.singlemodel.ddlBroker = $("#ddlBroker").val();
            $scope.singlemodel.txt_ISIN = $("#txt_ISIN").val();
            $scope.singlemodel.Type = $("#Type").val();
            $scope.singlemodel.txt_ClientCode = $("#txt_ClientCode").val();
            $scope.singlemodel.txt_SettlementNo =  $("#txt_SettlementNo").val();
            $scope.singlemodel.txt_OrderNo = $("#txt_OrderNo").val();
            $scope.singlemodel.txt_OrderTime= $("#txt_OrderTime").val();
            $scope.singlemodel.txt_TradeNo = $("#txt_TradeNo").val();
            $scope.singlemodel.txt_TradeTime = $("#txt_TradeTime").val();
            $scope.singlemodel.txt_TradeDate= $("#txt_TradeDate").val();
