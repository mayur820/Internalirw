...
app.controller("myctrn", function ($scope, $http, $localStorage, $sessionStorage, $window) {
    ...
    $scope.fnAdd = function () {
        ...
        if ($scope.btntextAdd == "Update") {
            ...
            $scope.Edititemsdata.InvestmentType =  $("#InvestmentType").val(); //Added by poonam as on 20 May 2022 //$scope.ddlInvenstmentType;  
            ...
            if ($("#btn_submit").val() == "Update") {
                ...
                m_Data.InvestmentType =  $("#InvestmentType").val(); //Added by poonam as on 20 May 2022 // $scope.ddlInvenstmentType;
