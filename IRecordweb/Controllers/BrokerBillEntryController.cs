...
namespace IRecordweb.Controllers
{
    public class BrokerBillEntryController : Controller
    {
        ...
        public JsonResult FnSaveManualEntryForEquity(string JsonData, string ExpenseData)
        {
            ...
            try
            {
                ...
                for (counter = 0; counter < dtJsonData.Rows.Count; counter++)
                {
                    ...
                    txtClientCode.Text = dtJsonData.Rows[counter]["txt_ClientCode"].ToString();
                    txtSettlementDate.Text = dtJsonData.Rows[counter]["txt_SettlementDate"].ToString();
                    txtISIN.Text = dtJsonData.Rows[counter]["txt_ISIN"].ToString();
                    txtOrderNo.Text = dtJsonData.Rows[counter]["txt_OrderNo"].ToString();
                    txtOrderTime.Text = dtJsonData.Rows[counter]["txt_OrderTime"].ToString();
                    txtTradeNo.Text = dtJsonData.Rows[counter]["txt_TradeNo"].ToString();
                    txtTradeTime.Text = dtJsonData.Rows[counter]["txt_TradeTime"].ToString();
                    ExchangeType = dtJsonData.Rows[counter]["ddlExchangeType"].ToString();
                ...
                if (Convert.ToInt32(vchno) > 0)
                {
                    cmd = new SqlCommand("INSERT INTO BrokerBill(Trans_no,Bill_no,Trans_Dt,Valan_code,MemberID,Broker_ID,Ac_Type,Brok_Rate,Brok_Amt,Amount,"
                        + " Stt_amt,ServTax_Amt,Other_amt,Net_amt,Book_Type,FinancialYearMemberID,Ref_TransNo,isInternalEntry,isFNOBill,Narrat1, settlementDate, Client_Code, ISIN, ExchangeType, OrderNo, OrderTime, TradeNo, TradeTime , CreatedBy, CreatedDate)values('" + vchno + "','"
                        ...
                        + invstyp + "','" + txtRemarks.Text + "','" + txtClientCode.Text + "','" + txtSettlementDate.Text + "','" + txtISIN.Text + "' ,'" + ExchangeType + "', '" + txtOrderNo.Text + "', '" + txtOrderTime.Text + "', '" + txtTradeNo.Text + "', '" + txtTradeTime.Text + "' ,'" + CreatedById.ToString() + "', getdate())", con);
                    ...
                    for (int counter1 = 0; counter1 < (dtJsonData.Rows.Count); counter1++)
                    {
                        ...
                        cmd = new SqlCommand("Insert into BrokerBill_Trans(Trans_No,Sr_No,Bill_no,Trans_Dt,TransType,Ac_Type,Script_ID,Qty,Bal_qty,G_Rate,Brok_Amt,ServTax_Amount,"
                            + " Rate,Amount,MemberID,FinancialYearMemberID,Consultant_ID,EntrySource,isIntraDay,Brok_PerUnit,isFNOBill,C_Gross_Rate,Exp_Rate,FrmNm,IsSLBS, ISIN, ExchangeType, OrderNo, OrderTime, TradeNo, TradeTime)values('" + vchno + "','"
                            ...
                            + SLBS + "','" + dtJsonData.Rows[counter1]["txt_ISIN"].ToString() + "','" + dtJsonData.Rows[counter1]["ddlExchangeType"].ToString() + "','" + dtJsonData.Rows[counter1]["txt_OrderNo"].ToString() + "','" + dtJsonData.Rows[counter1]["txt_OrderTime"].ToString() + "','" + dtJsonData.Rows[counter1]["txt_TradeNo"].ToString() + "','" + dtJsonData.Rows[counter1]["txt_TradeTime"].ToString() + "')", con);
                        cmd.Transaction = transaction;
                        cmd.ExecuteNonQuery();
                    }
        ...
        public JsonResult FnSaveManualEntryForFNO(string JsonData, string ExpenseData)
        {
            ...
            try
            {
                ...
                if (1 == 1)
                {
                    ...
                    //dr2.Read();ddlBroker
                    string oc2 = dtJsonData.Rows[0]["ddlBroker"].ToString().Replace("number", " ").Replace(":", " ");
                    //  dr2.Close();
                    ...
                    for (int counter = 0; counter < (dtJsonData.Rows.Count); counter++)
                    {
                        ...
                        txtInvestment.Text = "0";
                        txtClientCode.Text = dtJsonData.Rows[counter]["txt_ClientCode"].ToString();
                        txtSettlementDate.Text = Convert.ToDateTime(dtJsonData.Rows[counter]["txt_SettlementDate"].ToString()).ToString("dd/MM/yyyy");
                        string settlementDate = txtSettlementDate.Text;
                        txtISIN.Text = dtJsonData.Rows[counter]["txt_ISIN"].ToString();
                        txtOrderNo.Text = dtJsonData.Rows[counter]["txt_OrderNo"].ToString();
                        txtOrderTime.Text = dtJsonData.Rows[counter]["txt_OrderTime"].ToString();
                        txtTradeNo.Text = dtJsonData.Rows[counter]["txt_TradeNo"].ToString();
                    ...
                    cmd = new SqlCommand("INSERT INTO BrokerBill(Trans_no,Bill_no,Trans_Dt,Valan_code,MemberID,Broker_ID,Ac_Type,Brok_Rate,Brok_Amt,Amount,"
                        ...
                        + (Math.Abs(Convert.ToDouble(txtBrokerage.Text))) + "','" + (Math.Abs(Convert.ToDouble(txtGrossNetAmt.Text))) + "','0','0','"
                        + (Math.Abs(Convert.ToDouble(txtExpenses.Text))) + "','" + (Math.Abs(Convert.ToDouble(txtNetAmt.Text))) + "','BB','" + FinancialYearCode + "','','N','"
                        + invstyp + "','" + txtRemarks.Text + "','" + Convert.ToDateTime(txtSettlementDate.Text.ToString()).ToString("yyyy-MM-dd") + "','" + txtClientCode.Text + "','" + txtISIN.Text + "' ,'" + ExchangeType + "', '" + txtOrderNo.Text + "', '"
                        + txtOrderTime.Text + "', '" + txtTradeNo.Text + "', '" + txtTradeTime.Text + "' ,'" + CreatedById.ToString() + "', getdate())", con)
                    {
                        Transaction = transaction
                    };
                    ...
                    for (int counter1 = 0; counter1 < (dtJsonData.Rows.Count); counter1++)
                    {
                        ...
                        cmd = new SqlCommand("Insert into BrokerBill_Trans(Trans_No, Sr_No, Bill_no, Trans_Dt, TransType, Ac_Type, Script_ID, Qty, G_Rate, Brok_Amt,"
                            ...
                            + " isFNOBill, Strike_Price, OptionType, isstock,FrmNm , ISIN, ExchangeType, OrderNo, OrderTime, TradeNo, TradeTime)values('" + vchno + "', '" + srnr + "', '" + txtBillNo.Text + "', '" + Trasndate
                            ...
                            + dtJsonData.Rows[counter1]["StrikePrice"].ToString() + "','" + optyp + "','" + sttyp + "','BB','" + dtJsonData.Rows[counter1]["txt_ISIN"].ToString()
                            + "','" + dtJsonData.Rows[counter1]["ddlExchangeType"].ToString() + "','" + dtJsonData.Rows[counter1]["txt_OrderNo"].ToString() + "','" + dtJsonData.Rows[counter1]["txt_OrderTime"].ToString()
                            + "','" + dtJsonData.Rows[counter1]["txt_TradeNo"].ToString() + "','" + dtJsonData.Rows[counter1]["txt_TradeTime"].ToString() + "')", con)
                        {
                            Transaction = transaction
                        };
                        cmd.ExecuteNonQuery();
        ...
        public JsonResult FnGetScript(int ScriptID)
        {
            String strConnString = ConfigurationManager.ConnectionStrings["IrecordwebConnection"].ConnectionString;
            SqlConnection con = new SqlConnection(strConnString);
            SqlCommand cmd = new SqlCommand();
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "[dbo].[SP_Get_Script_ISIN]";

            cmd.Parameters.Add("@Action", SqlDbType.VarChar).Value = "GETISIN";
            cmd.Parameters.Add("@ScriptID", SqlDbType.BigInt).Value = ScriptID;
        ...
        public JsonResult FnGetClientCode(int BrokerID)
        {
            String strConnString = ConfigurationManager.ConnectionStrings["IrecordwebConnection"].ConnectionString;
            SqlConnection con = new SqlConnection(strConnString);
            SqlCommand cmd = new SqlCommand();
            ...
            cmd.Parameters.Add("@Action", SqlDbType.VarChar).Value = "GETCLIENTCODE";
            cmd.Parameters.Add("@BrokerID", SqlDbType.BigInt).Value = BrokerID;
        ...
        //    cmd.CommandType = CommandType.StoredProcedure;
        //    cmd.CommandText = "[SP_Get_Script_ISIN]";
        ...
        public ActionResult BRDetails()
        {
            ...
            try
            {
                ...
                dataobj.SelectedDate = data.Date;
              ...
              //  if (myDataSet.Tables[0]["TradeDate"] > FINANCIALYEAR.)
            }
            catch (Exception ex)
            {
        ...
        public void SaveEquity_Save_For_Equity()
        {
                ...
                if (Convert.ToInt32(vchno) > 0)
                {
                    ...
                    for (int counter1 = 0; counter1 < (Dt_Details.Rows.Count); counter1++)
                    {
                        ...
                        cmd = new SqlCommand("Insert into BrokerBill_Trans_Process(ScriptName,Trans_No,Sr_No,Bill_no,Trans_Dt,TransType,Ac_Type,Script_Code,Qty,Bal_qty,G_Rate,Brok_Amt,ServTax_Amount,"
                            + " Rate,Amount,Member_code,YearCode,Consultant_Code,EntrySource,isIntraDay,Brok_PerUnit,isFNOBill,C_Gross_Rate,Exp_Rate,FrmNm,IsSLBS, ISIN, SettlementDate, Client_Code,ExchangeType,OrderNo,OrderTime,TradeNo,TradeTime)values('" + Dt_Details.Rows[counter1]["ScriptName"].ToString() + "','" + vchno + "','"
                            ...
                            + SLBS + "', '" + Dt_Details.Rows[counter1]["ISIN"].ToString() + "', '" + Dt_Details.Rows[counter1]["SettlementDate"].ToString() + "', '" + Dt_Details.Rows[counter1]["Client_Code"].ToString() + "', '" + Dt_Details.Rows[counter1]["ExchangeType"].ToString() + "', '" + Dt_Details.Rows[counter1]["OrderNo"].ToString()
                            + "', '" + Dt_Details.Rows[counter1]["OrderTime"].ToString() + "', '" + Dt_Details.Rows[counter1]["TradeNo"].ToString() + "', '" + Dt_Details.Rows[counter1]["TradeTime"].ToString() + "')", con);
                        cmd.Transaction = transaction;
                        cmd.ExecuteNonQuery();
                    }
                    for (int counter1 = 0; counter1 < (Dt_Expanses.Rows.Count); counter1++)
            ...
            // SetIntraDays(vchno);   // Commented By Poonam on 11 March 2022
        }
        ...
        public JsonResult SaveBREntry(BREntryModel data)
        {
            ...
            try
            {
                ...
                //DataTable dt = InsertGroupMaster(MemberCode, FinancialYearCode);
                //InsertDefaultAccount(MemberCode, FinancialYearCode);
            ...
            try
            {
               // SaveBrokerWithDemat(MemberCode, FinancialYearCode, MemberBrokerId, MemberBankId);
            }
            catch { }
            try
            {
                SaveDemat(MemberCode, FinancialYearCode, MemberBrokerId, MemberBankId);
            }
            catch (Exception ex)
            { }
            //try
            ...
            try
            {
              //  SetDefault_BrokerWithDemat(MemberCode, FinancialYearCode, Dt_DefaultList.Rows[0]["Broker"].ToString().Split(':')[2].ToString());
            }
            catch { }
            try
            {
               // SetDefault_Demat(MemberCode, FinancialYearCode, Dt_DefaultList.Rows[0]["Demate"].ToString().Split(':')[2].ToString());
            }
            catch { }
            //try
            //{
        ...
        public ActionResult Import(string Close, String Upload, HttpPostedFileBase FilePath, BrokerBill _Broker)
        {
            ...
            if (!string.IsNullOrEmpty(Upload))
            {
                ...
                string fileextenion = Path.GetExtension(FilePath.FileName);
                string ContentType = FilePath.ContentType.ToString();
                string SelectedDate = _Broker.Date.ToString();
        ...
        [HttpPost]
        public JsonResult SetMultiConfiguration(string JsonDefaultValues, string ListOfBroker, string ListOfDemate, string ListOfConsultant)
        {
            Session["OnBorValidMember"] = "1";
            Session["JsonDefaultValues"] = JsonDefaultValues;
            Session["ListOfBroker"] = ListOfBroker;//
            Session["ListOfDemate"] = ListOfDemate;//
            Session["ListOfConsultant"] = ListOfConsultant;
            return Json("1", JsonRequestBehavior.AllowGet);
        }
        ...
        {
            string ListOfBroker = Session["ListOfBroker"] as string;
            if (ListOfBroker != "[]")
            {
                DataTable dt_ListOfBrokerWithDemate = Newtonsoft.Json.JsonConvert.DeserializeObject<DataTable>(ListOfBroker);
        ...
        public DataTable InsertGroupMaster(string MemberID, string FinancialYearMemberId)
        {
            ...
            cmd.Parameters.Add("@Action", SqlDbType.NVarChar).Value = "Get_Broker_Bank";   //Initialize_Group - add new Action by Poonam on 13 May 2022
            cmd.Parameters.Add("@MemberId", SqlDbType.Int).Value = MemberID;
            cmd.Parameters.Add("@FinancialYearMemberId", SqlDbType.Int).Value = FinancialYearMemberId;
        ...
        {
            string ListOfDemate = Session["ListOfDemate"].ToString(); //as string;
            if (ListOfDemate != "[]")
            {
                DataTable dt_ListOfBrokerWithDemate = Newtonsoft.Json.JsonConvert.DeserializeObject<DataTable>(ListOfDemate) as DataTable;
                foreach (DataRow dr in dt_ListOfBrokerWithDemate.Rows)
                {
                    #region
        ...
        System.Web.UI.WebControls.TextBox txtISIN = new System.Web.UI.WebControls.TextBox();
        System.Web.UI.WebControls.TextBox txtClientCode = new System.Web.UI.WebControls.TextBox();
        System.Web.UI.WebControls.TextBox txtSettlementDate = new System.Web.UI.WebControls.TextBox();
        System.Web.UI.WebControls.TextBox txtOrderNo = new System.Web.UI.WebControls.TextBox();
        System.Web.UI.WebControls.TextBox txtOrderTime = new System.Web.UI.WebControls.TextBox();
        System.Web.UI.WebControls.TextBox txtTradeNo = new System.Web.UI.WebControls.TextBox();
        System.Web.UI.WebControls.TextBox txtTradeTime = new System.Web.UI.WebControls.TextBox();
        ...
        public void SaveEquity()
        {
            ...
            txtBillNo.Text = Dt_Header.Rows[0]["BillNo"].ToString();
            txtSettlementNo.Text = Dt_Header.Rows[0]["SettlementNo"].ToString();
            string SettlementDate = Dt_Header.Rows[0]["SettlementDate"].ToString();
            string Client_Code = Dt_Header.Rows[0]["Client_Code"].ToString();
            ...
            try
            {
                if (Validate_FNO())
                {
                    ...
                    string ISIN = "", OrderNo = "", OrderTime = "", TradeNo = "", TradeTime = "", ExchangeType = "";
                    for (counter = 0; counter < Dt_Details.Rows.Count; counter++)
                    {

                        ISIN = Dt_Details.Rows[counter]["ISIN"].ToString();
                        ExchangeType = Dt_Details.Rows[counter]["ExchangeType"].ToString();
                        OrderNo = Dt_Details.Rows[counter]["OrderNo"].ToString();
                        OrderTime = Dt_Details.Rows[counter]["OrderTime"].ToString();
                        TradeNo = Dt_Details.Rows[counter]["TradeNo"].ToString();
                        TradeTime = Dt_Details.Rows[counter]["TradeTime"].ToString();
                        string styp = Dt_Details.Rows[counter]["HoldingType"].ToString();
                        string[] detailss = styp.Split('-');
                        if (Dt_Details.Rows[counter]["Type"].ToString() == "Bought" & detailss[0] == "I")
                            amtbfacI = Math.Round(amtbfacI + Math.Round(double.Parse(Dt_Details.Rows[counter]["Amount"].ToString()), decmlpl), decmlpl);
                    ...
                    {
                        cmd = new SqlCommand("INSERT INTO BrokerBill(Trans_no,Bill_no,Trans_Dt,Valan_code,MemberID,Broker_ID,Ac_Type,Brok_Rate,Brok_Amt,Amount,"
                            + " Stt_amt,ServTax_Amt,Other_amt,Net_amt,Book_Type,FinancialYearMemberID,Ref_TransNo,isInternalEntry,isFNOBill,Narrat1,ISIN,SettlementDate, Client_Code, ExchangeType,OrderNo,OrderTime,TradeNo,TradeTime, CreatedBy, CreatedDate)values('" + vchno + "','"
                            ...
                            + invstyp + "','" + txtRemarks.Text + "' , '" + ISIN + "','" + SettlementDate + "','" + Client_Code + "', '" + ExchangeType.ToString() + "', '" + OrderNo.ToString()
                            + "', '" + OrderTime + "', '" + TradeNo + "', '" +
                            TradeTime + "', '" + CreatedById + "', getdate())", con);
                        cmd.Transaction = transaction;
                        cmd.ExecuteNonQuery();
                        ...
                        if (!checkBox3.Checked)
                        {
                            ...
                            // if  Gross Amont Stock In Trade Entry Less Then Expense Amount    // Removed Data
                        ...
                        for (int counter1 = 0; counter1 < (Dt_Details.Rows.Count); counter1++)
                        {
                            ...
                            double bkrch = Math.Round(Math.Round(double.Parse(Dt_Details.Rows[counter1]["BrokAmt"].ToString()), 4) / Math.Round(double.Parse(Dt_Details.Rows[counter1]["Qty"].ToString()), 4), 4);
                            cmd = new SqlCommand("Insert into BrokerBill_Trans(Trans_No,Sr_No,Bill_no,Trans_Dt,TransType,Ac_Type,Script_ID,Qty,Bal_qty,G_Rate,Brok_Amt,ServTax_Amount,"
                                + " Rate,Amount,MemberID,FinancialYearMemberID,Consultant_ID,EntrySource,isIntraDay,Brok_PerUnit,isFNOBill,C_Gross_Rate,Exp_Rate,FrmNm,IsSLBS,ISIN, ExchangeType,OrderNo,OrderTime,TradeNo,TradeTime, HoldingType)values('" + vchno + "','"
                                + srnr + "','" + txtBillNo.Text + "','" + Trasndate + "','" + Dt_Details.Rows[counter1]["Type"].ToString() + "','" + actyp + "','" + sccd + "','"
                                + Dt_Details.Rows[counter1]["Qty"].ToString() + "','" + Dt_Details.Rows[counter1]["Qty"].ToString() + "','"
                                + Dt_Details.Rows[counter1]["GrossRate"].ToString() + "','" + Dt_Details.Rows[counter1]["BrokAmt"].ToString() + "','0','"
                                + Dt_Details.Rows[counter1]["Rate"].ToString() + "','" + Dt_Details.Rows[counter1]["Amount"].ToString() + "','"
                                + MenuMaster.member_code + "','" + MenuMaster.yearcode + "','" + ccd + "','0','" + intrday + "','" + bkrch + "','" + invstyp + "','"
                                + Dt_Details.Rows[counter1]["GrossRate"].ToString() + "','" + Dt_Details.Rows[counter1]["Rate"] + "','BB','"
                                + SLBS + "','" + Dt_Details.Rows[counter1]["ISIN"].ToString() + "', '" + Dt_Details.Rows[counter1]["ExchangeType"].ToString() + "', '" + Dt_Details.Rows[counter1]["OrderNo"].ToString()
                                + "', '" + Dt_Details.Rows[counter1]["OrderTime"].ToString() + "', '" + Dt_Details.Rows[counter1]["TradeNo"].ToString() + "', '" +
                                Dt_Details.Rows[counter1]["TradeTime"].ToString() + "', '"+ Dt_Details.Rows[counter1]["HoldingType"].ToString() + "')", con);
                            cmd.Transaction = transaction;
                            cmd.ExecuteNonQuery();
                        }
                        for (int counter1 = 0; counter1 < (Dt_Expanses.Rows.Count); counter1++)
        ...
        public void SaveFNO()
        {
            ...
            try
            {
                if (Validate_FNO())
                {
                    ...
                    cmd = new SqlCommand("INSERT INTO BrokerBill(Trans_no,Bill_no,Trans_Dt,Valan_code,MemberID,Broker_ID,Ac_Type,Brok_Rate,Brok_Amt,Amount,"
                        + " Stt_amt,ServTax_Amt,Other_amt,Net_amt,Book_Type,FinancialYearMemberID,Ref_TransNo,isInternalEntry,isFNOBill,Narrat1,SettlementDate, Client_Code)values('" + vchno + "','"
                        + txtBillNo.Text + "','" + theDate1 + "','" + txtSettlementNo.Text + "','" + MenuMaster.member_code + "','" + oc2 + "','" + drorcr + "','0','"
                        + (Math.Abs(Convert.ToDouble(txtBrokerage.Text))) + "','" + (Math.Abs(Convert.ToDouble(txtGrossNetAmt.Text))) + "','0','0','"
                        + (Math.Abs(Convert.ToDouble(txtExpenses.Text))) + "','" + (Math.Abs(Convert.ToDouble(txtNetAmt.Text))) + "','BB','" + MenuMaster.yearcode + "','','N','"
                        + invstyp + "','" + txtRemarks.Text + "','" + SettlementDate + "','" + Client_Code + "');SELECT SCOPE_IDENTITY();", con)
                    {
                        Transaction = transaction
                    };
                    ...
                    for (int counter1 = 0; counter1 < (Dt_Details.Rows.Count); counter1++)
                    {
                        ...
                        cmd = new SqlCommand("Insert into BrokerBill_Trans(Trans_No, Sr_No, Bill_no, Trans_Dt, TransType, Ac_Type, Script_ID, Qty, G_Rate, Brok_Amt,"
                            + " ServTax_Amount, Rate, Amount, MemberID, FinancialYearMemberID, Consultant_ID, EntrySource,Brok_PerUnit, MonthYear, Last_Date, LotSize, LotQty,"
                            + " isFNOBill, Strike_Price, OptionType, isstock,FrmNm,ISIN, ExchangeType,OrderNo,OrderTime,TradeNo,TradeTime, FUT_OPT , HoldingType)values('" + vchno + "', '" + srnr + "', '" + txtBillNo.Text + "', '" + Trasndate
                            ...
                            + ccd + "', '0', '" + bkrch + "','" + expmonth + "','" + expdt + "','" + Dt_Details.Rows[counter1]["Lott"].ToString() + "','"
                            + Dt_Details.Rows[counter1]["LotQty"].ToString() + "','" + invstyp + "','"
                            + Dt_Details.Rows[counter1]["StrikePrice"].ToString() + "','" + optyp + "','" + sttyp + "','BB','" + Dt_Details.Rows[counter1]["ISIN"].ToString() + "', '" + Dt_Details.Rows[counter1]["ExchangeType"].ToString() + "', '" + Dt_Details.Rows[counter1]["OrderNo"].ToString()
                                + "', '" + Dt_Details.Rows[counter1]["OrderTime"].ToString() + "', '" + Dt_Details.Rows[counter1]["TradeNo"].ToString() + "', '" +
                                Dt_Details.Rows[counter1]["TradeTime"].ToString() + "','" + Dt_Details.Rows[counter1]["FUT_OPT"].ToString() + "')", con)
                        {
                            Transaction = transaction
                        };
                        cmd.ExecuteNonQuery();
